...
""" V4 - 05/08/2019 -  this program presents user with a static window containing the game layout; spawns aliens randomly; allows user to shoot at the alien;
...
laser shooting is now synchronized with typing; menu is now present and fully functional ; user data is stored in a separate .txt file; calculations of accuracy and wpm are now present.
"""
# IMPORTS
...
def initializeGlobals():
    global main_window_height, main_window_width, main_window_offset_x, main_window_offset_y, text_score_style, text_lives_style, \
        ...
        total_words, speed, AMMO, ALIEN_CONFIG
...
def mainMenu():
    ...
    widget_menu_box = game_canvas.create_rectangle(200, 120, 500, 360, fill = "black")
    widget_title_box = game_canvas.create_rectangle(220, 140, 480, 190, fill = "blue")
    widget_name = game_canvas.create_text(350, 167, text = "Keyboard warrior", fill = "yellow", font = ("ARIAL", "20", "bold"))
    ...
    button_window = game_canvas.create_window(350, 230, window=button_start)
    ...
    button_window = game_canvas.create_window(350, 280, window=button_stats)
    ...
    button_window = game_canvas.create_window(350, 330, window=button_options)
...
def statsMenu():
    ...
    widget_final_score = game_canvas .create_text(350, 200 , text = "{}{}".format("Max score: ", max_score), fill = "white",  font = text_score_style)
    widget_final_wave = game_canvas.create_text(350, 250, text="{}{}".format("Max wave reached: ", max_wave), fill="white", font=text_wave_style)
    widget_final_accuracy = game_canvas.create_text(350, 300, text="{}{}{}".format("Accuracy: " , max_accuracy, "%"), fill="white", font=text_wave_style)
    widget_final_wpm = game_canvas.create_text(350, 350, text="{}{}".format("Max WPM: " , max_wpm), fill="white", font=text_wave_style)
...
def createGameLayout():
    global game_canvas, widget_sun, widget_score, widget_lives, widget_wave, root,  \
            image_earth, widget_earth, image_sun, image_space_background
    ...
    widget_lives = game_canvas.create_text(109,575, text = "{}{}".format("Earth Lives: ", user_lives), fill = "white", font = text_lives_style, tag = "lives")
