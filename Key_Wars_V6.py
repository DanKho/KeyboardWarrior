...
""" V5 - 28/07/2019 -  this program presents user with a static window containing the game layout; spawns aliens randomly; allows user to shoot at the alien;
...
laser shooting is now synchronized with typing; menu is now present and fully functional ; user data is stored in a separate .txt file; calculations of accuracy and wpm are now present; earth lives are now represented
as 3 separate heart images; there is a box on top of the screen displaying the current word; aliens have changing appearances.
"""
# IMPORTS
...
def initializeGlobals():
    global main_window_height, main_window_width, main_window_offset_x, main_window_offset_y, text_score_style, text_lives_style, \
        ...
        total_words, speed, AMMO, ALIEN_CONFIG, image_turret_path
...
def createGameLayout():
    global game_canvas, widget_sun, widget_score, widget_lives, widget_wave, root,  \
            image_earth, widget_earth, image_sun, image_space_background, image_turret, x_ea_c, y_ea_c
...
def wordContainerUpdate():
    global current_word
    dispay_word = game_canvas.create_text(351, 21, text = current_word, fill="yellow",font=("ROBOTO", "14"), tag = "container_text")
